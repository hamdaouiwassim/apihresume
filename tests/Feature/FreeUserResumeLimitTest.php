...
class FreeUserResumeLimitTest extends TestCase
{
    ...
    public function test_free_user_can_create_second_resume(): void
    {
        $user = User::factory()->create(['is_pro' => false]);
        $template = $this->template();
        Resume::create([
    ...
    public function test_free_user_cannot_create_third_resume(): void
    {
        $user = User::factory()->create(['is_pro' => false]);
        $template = $this->template();
        Resume::create([
    ...
    public function test_resume_index_includes_creation_limits(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('limits.owned_limit', 2)
            ->assertJsonPath('limits.can_create', true);
    }
}
