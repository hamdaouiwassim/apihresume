...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Fonts -->
        {{-- Figtree self-hosted (public/fonts/figtree) instead of fonts.bunny.net --}}
        <style>
            @font-face { font-family: 'Figtree'; font-style: normal; font-weight: 300; font-display: swap; src: url('/fonts/figtree/figtree-latin-300-normal.woff2') format('woff2'); }
            @font-face { font-family: 'Figtree'; font-style: normal; font-weight: 400; font-display: swap; src: url('/fonts/figtree/figtree-latin-400-normal.woff2') format('woff2'); }
            @font-face { font-family: 'Figtree'; font-style: normal; font-weight: 500; font-display: swap; src: url('/fonts/figtree/figtree-latin-500-normal.woff2') format('woff2'); }
            @font-face { font-family: 'Figtree'; font-style: normal; font-weight: 600; font-display: swap; src: url('/fonts/figtree/figtree-latin-600-normal.woff2') format('woff2'); }
        </style>
